  ...
  return (
    <div className="bg-custom-graybg lg:p-6 rounded-lg shadow-md w-full">
      <div className='flex justify-between'>
        <h2 className="text-2xl font-semibold text-custom-maroon mb-4 font-cursive">How Will Your Donation Help Dklean Health Care Public Charitable Trust (N.G.O.)?</h2>
      ...
      <h3 className="text-xl font-semibold text-custom-maroon mb-3 font-cursive">Why Donate to Dklean Health Care Public Charitable Trust (N.G.O.)?</h3>
      <p className="text-lg text-gray-700 mb-4">
