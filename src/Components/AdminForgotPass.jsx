...
const role = "admin";
  ...
  const otpVerifyChangePass = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${BaseUrl}/api/auth/updatePasswordOtp`,
        payload,
        { headers: { "Content-Type": "application/json" } }
      );
  ...
  return (
    <div className="Forgot Password">
      ...
      >
        <div className="mb-5">
          <div className="heading text-center font-bold text-2xl">
            Admin <span className="text-custom-maroon">Forgot Password</span>
          </div>
      ...
      <div className="flex items-center justify-center">
        ...
        <Link to="../admin" className="pl-5 text-blue-500 font-bold underline">
          Login Page
        </Link>
      </div>
    </div>
